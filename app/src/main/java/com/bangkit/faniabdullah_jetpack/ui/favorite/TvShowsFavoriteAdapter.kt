...
class TvShowsFavoriteAdapter :
    PagedListAdapter<TvShowsEntity, TvShowsFavoriteAdapter.TvShowsViewHolder>(DIFF_CALLBACK) {
    ...
    inner class TvShowsViewHolder(private val binding: MovieItemFavBinding) :
